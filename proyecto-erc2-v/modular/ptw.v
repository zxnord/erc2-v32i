...
module ptw(
    ...
    // FSM States for 1-cycle memory latency
    localparam IDLE            = 4'd0;
    localparam L1_ADDR_CALC    = 4'd1;
    localparam L1_FETCH        = 4'd2;
    localparam L0_ADDR_CALC    = 4'd3;
    localparam L0_FETCH        = 4'd4;
    ...
    always @(posedge clk or posedge reset) begin
        if (reset) begin
            ...
            mem_read_enable_out <= 1'b0; // Default to no read
            ...
            case (state)
                ...
                L1_FETCH: begin
                    // Latch the data from memory (available in this cycle)
